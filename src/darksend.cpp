...
{
    if(fLiteMode) return; // ignore all Sscoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Sscoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("sscoin-privatesend");
