    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sscoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sscoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sscoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sscoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sscoin Core"));
    ...
    openAction->setStatusTip(tr("Open a sscoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sscoin Core help message to get a list with possible Sscoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sscoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Sscoin Core"); // default title
