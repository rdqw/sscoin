    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SSCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("SSCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SSCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SSCOIN-traditional"), QVariant("trad"));
