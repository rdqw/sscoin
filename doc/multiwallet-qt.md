...
Only requiring some minor changes is sscoin.cpp.
...
Changes to sscoin.cpp
----------------------
sscoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
