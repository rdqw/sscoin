 ...
 *
 *   // network
 *   CSscoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sscoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSscoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SscoinNetwork
// //   -- signature requirements : Key1(User)
// class CSscoinNetworkVariable : public CGovernanceObject
// {
// private:
