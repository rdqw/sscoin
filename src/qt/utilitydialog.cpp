    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sscoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sscoin Core"));
...
All the Sscoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SSCOIN, 0.1 SSCOIN, 1 SSCOIN and 10 SSCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rqdw.atlassian.net/wiki/display/DOC/PrivateSend\">https://rqdw.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sscoin Core is shutting down...") + "<br /><br />" +
