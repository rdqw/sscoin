...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SscoinNetwork") type = SscoinNetwork;
    if(strType == "SscoinNetworkVariable") type = SscoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SscoinNetwork) s = "SscoinNetwork";
    if(type == SscoinNetworkVariable) s = "SscoinNetworkVariable";
