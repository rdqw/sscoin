...
This mechanism has been integrated into Bitcore-Node-Sscoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rqdw/insight-api-sscoin#web-socket-api](https://github.com/rqdw/insight-api-sscoin#web-socket-api) 
* API: [https://github.com/rqdw/insight-api-sscoin#instantsend-transactions](https://github.com/rqdw/insight-api-sscoin#instantsend-transactions) 
...
By default, the Sscoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sscoin Core daemon:
