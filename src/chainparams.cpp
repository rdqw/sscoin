...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("sscoin.org", "dnsseed.sscoin.org"));
        vSeeds.push_back(CDNSSeedData("sscoindot.io", "dnsseed.sscoindot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("rqdw.io", "dnsseed.rqdw.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("sscoindot.io",  "testnet-seed.sscoindot.io"));
